      ...
      .then((data) => {
        ...
        if (typeof data === 'string' && data.includes('PRO FEATURE ONLY')) {
          ...
          setStations([
            ...
            { id: 'place-portr', name: 'Porter Square', lines: ['Red', 'CR-Fitchburg'] },
            ...
            { id: 'place-pktrm', name: 'Park Street', lines: ['Red', 'Green-B', 'Green-C', 'Green-D', 'Green-E'] },
            { id: 'place-dwnxg', name: 'Downtown Crossing', lines: ['Red', 'Orange'] },
            { id: 'place-sstat', name: 'South Station', lines: ['Red', 'Silver', 'CR-Worcester', 'CR-Franklin', 'CR-Needham'] },
            ...
            { id: 'place-north', name: 'North Station', lines: ['Green-C', 'Green-E', 'Orange', 'CR-Fitchburg', 'CR-Lowell'] },
            { id: 'place-haecl', name: 'Haymarket', lines: ['Orange', 'Green-C', 'Green-E'] },
            { id: 'place-state', name: 'State', lines: ['Blue', 'Orange'] },
            { id: 'place-tumnl', name: 'Tufts Medical Center', lines: ['Orange'] },
            { id: 'place-bbsta', name: 'Back Bay', lines: ['Orange', 'CR-Worcester', 'CR-Franklin', 'CR-Needham'] },
            { id: 'place-masta', name: 'Massachusetts Avenue', lines: ['Orange'] },
            ...
            { id: 'place-forhl', name: 'Forest Hills', lines: ['Orange', 'CR-Needham'] },
            ...
            { id: 'place-govct', name: 'Government Center', lines: ['Blue', 'Green-C', 'Green-D', 'Green-E'] },
            { id: 'place-bomnl', name: 'Bowdoin', lines: ['Blue'] },
            { id: 'place-armnl', name: 'Arlington', lines: ['Green-B', 'Green-C', 'Green-D', 'Green-E'] },
            { id: 'place-boyls', name: 'Boylston', lines: ['Green-B', 'Green-C', 'Green-D', 'Green-E'] },
            { id: 'place-coecl', name: 'Copley', lines: ['Green-B', 'Green-C', 'Green-D'] },
            { id: 'place-hymnl', name: 'Hynes Convention Center', lines: ['Green-B', 'Green-C', 'Green-D'] },
            { id: 'place-kencl', name: 'Kenmore', lines: ['Green-B', 'Green-C', 'Green-D'] },
            ...
            { id: 'place-NHRML-0494', name: 'Fitchburg', lines: ['CR-Fitchburg'] },
            ...
            { id: 'place-WML-0199', name: 'Wellesley Square', lines: ['CR-Worcester'] },
            { id: 'place-WML-0125', name: 'Newtonville', lines: ['CR-Worcester'] },
            { id: 'place-FR-0115', name: 'Franklin', lines: ['CR-Franklin'] },
            { id: 'place-FR-0064', name: 'Forge Park', lines: ['CR-Franklin'] },
            { id: 'place-FS-0049', name: 'Norwood Central', lines: ['CR-Franklin'] },
            { id: 'place-NEC-2203', name: 'Needham Center', lines: ['CR-Needham'] },
            { id: 'place-NEC-2139', name: 'Needham Heights', lines: ['CR-Needham'] },
            { id: 'place-NEC-2050', name: 'Needham Junction', lines: ['CR-Needham'] },
            { id: 'place-NHRML-0127', name: 'Lowell', lines: ['CR-Lowell'] },
            { id: 'place-NHRML-0152', name: 'Anderson/Woburn', lines: ['CR-Lowell'] },
          ]);
        } else {
